/**
 * Title: "Magic Powder - 1", Codeforces problem. 
...
bool check(const vector<Ingredient> &grams, int K, int middle)
{
    for(auto &it : grams) {
...
int binarySearch(const vector<Ingredient> &grams,int K)
{
